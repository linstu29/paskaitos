...
542222222222222222222222222222222222222222222222222222222222222
...
let vardas = 'Lina';
let pavarde = 'Stundyte';
let gimimo_metai = 2001;
let esami_metai = 2024;

console.log('As esu', vardas, pavarde, '.', 'Man yra', esami_metai - gimimo_metai, 'metai.');
...
let random = Math.floor(Math.random() * (numb1 / numb2 + 1) + numb2);
console.log(random);
...
let rand = Math.floor(Math.random() * (nr1 / numb2 + 1) + numb2);
console.log(random);
